            ...
            <main id="main" class="site-main container" role="main" style="display:block">
                ...
                <div style="height: 3079px;" class="sidbear sidebar1 column">
                    ...
                    <div class="widget widget_latest_posts">
                        ...
                        <ul>
                            <li>
                                <a href="http://dev.theme-junkie.com/html/supernews/post.html"><img class="entry-thumbnail" src="<?php echo base_url(); ?>assets/view/logo.png" alt="Post Title"></a>
                        ...
                        <ul>
                            <li>
                                <a href="http://dev.theme-junkie.com/html/supernews/post.html#comments">
                                    <img class="avatar" src="<?php echo base_url(); ?>assets/view/logo.png" alt="Author Name">
                ...
                <div style="height: 3079px;" id="secondary" class="widget-area widget-primary sidebar2 column" role="complementary">
                    ...
                    <div class="widget widget_ads">
                        ...
                        <a href="http://websoftnepal.com" target="_blank"><img src="<?php echo base_url(); ?>assets/view/images/websoft.jpg" alt="Ad Widget"></a>
                    </div><!-- .widget .widget_ads -->
                        ...
                        <div class="tabs-container">
                            ...
                            <div style="display: block;" class="tab-content" id="tab1">
                                <ul>
                                    ...
                                    <li class="clearfix">
                                        <a href="" rel="bookmark"><img class="entry-thumbnail" src="<?php echo base_url()."upload/thumb_".$lest->image; ?>" alt="Post Title"></a>
                                        <h2 class="entry-title"><a href="" rel="bookmark"><?php echo $lest->title;  ?></a></h2>
                            ...
                            <div style="display: none;" class="tab-content" id="tab2">
                                <ul>
                                    <li class="clearfix">
                                        <a href="http://dev.theme-junkie.com/html/supernews/post.html" rel="bookmark"><img class="entry-thumbnail" src="<?php echo base_url(); ?>assets/view/logo.png" alt="Post Title"></a>
                            ...
                            <div style="display: none;" class="tab-content" id="tab3">
                                <ul>
                                    <li class="clearfix">
                                        <a href="http://dev.theme-junkie.com/html/supernews/post.html#comments"><img class="entry-thumbnail" src="<?php echo base_url(); ?>assets/view/logo.png" alt="Author Name"></a>
                    ...
                    <div class="widget widget_125">
                        ...
                        <a href="#"><img class="img-right" src="<?php echo base_url(); ?>assets/view/images/websodt.jpg" alt=""></a>
                        <a href="#"><img src="<?php echo base_url(); ?>assets/view/images/websoft.jpg" alt=""></a>
                            ...
                            <li style="height: 186px;">
                                <article class="hentry post">
                                    <a class="video-thumbnail" href="http://dev.theme-junkie.com/html/supernews/post_video.html" rel="bookmark">
                                        <img class="entry-thumbnail" src="<?php echo base_url(); ?>assets/view/logo.png" alt="Post Title">
